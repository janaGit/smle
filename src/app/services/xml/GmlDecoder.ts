...
export class GmlDecoder {
    ...
    public decodeTimePeriod(elem: Element): ReturnObject<AbstractTime> {
        ...
        if (timeElem != null) {
            ...
            if (beginPositionElem != null) {
                ...
                this._profileIDMap = this.utils.processProfileID(beginPositionElem, period, "begin", this._profileIDMap);
    ...
    public decodeAbstractGML(elem: Element, object: AbstractGML): void {
        ...
        if (identifierElem != null) {
           ...
           if (returnObject) { object.identifier = returnObject.value;
    ...
    public decodeAbstractFeature(elem: Element, abstractFeature: AbstractFeature): void {
        ...
        if (boundedByElem != null) {
            ...
            this._profileIDMap = this.utils.processProfileID(boundedByElem, abstractFeature, "boundedBy", this._profileIDMap);
        ...
        if (envelopeElem != null) {
            ...
            if (lowerCorner != null) {
                ...
                if (lc.length === 2) {
                    ...
                    this._profileIDMap = this.utils.processProfileID(lowerCorner, envelope, "lowerCorner", this._profileIDMap);
            ...
            if (upperCorner != null) {
                ...
                if (uc.length === 2) {
                    ...
                    this._profileIDMap = this.utils.processProfileID(upperCorner, envelope, "upperCorner", this._profileIDMap);
