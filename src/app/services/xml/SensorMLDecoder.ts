...
export class SensorMLDecoder {
    ...
    public decodeAbstractPhysicalProcess(elem: Element, object: AbstractPhysicalProcess): void {
        ...
        let returnObject: ReturnObject<string> = this.utils.getAttributeOfElement(elem, 'attachedTo', Namespaces.SML, 'href', Namespaces.XLINK);
        ...
        object.position = this.utils.getDecodedList(elem, 'position', Namespaces.SML, this._profileIDMap, (pos) => this.decodePosition(pos));
    ...
    public decodeAbstractProcess(elem: Element, object: AbstractProcess): void {
        ...
        let returnObject: ReturnObject<string> = this.utils.getAttributeOfElement(elem, 'typeOf', Namespaces.SML, 'href', Namespaces.XLINK);
        if (returnObject) {
        ...
        if (settings != null) {
            ...
            if (returnObject) {
                ...
                this._profileIDMap = this.utils.processProfileID(returnObject.docElement, object, "configuration", this._profileIDMap);
            }
        }
        ...
        if (features != null) {
            ...
            if (returnObject) {
                ...
                this._profileIDMap = this.utils.processProfileID(returnObject.docElement, object, "featureOfInterest", this._profileIDMap);
            }
        }
        ...
        if (inputsElem != null) {
            ...
            if (returnObject) {
                ...
                this._profileIDMap = this.utils.processProfileID(returnObject.docElement, object, "inputs", this._profileIDMap);
            }
            ...
            if (outputsElem != null) {
                ...
                if (returnObject) {
                    ...
                    this._profileIDMap = this.utils.processProfileID(returnObject.docElement, object, "outputs", this._profileIDMap);
                }
            }
            ...
            if (parameters != null) {
                ...
                if (returnObject) {
                    ...
                    this._profileIDMap = this.utils.processProfileID(returnObject.docElement, object, "parameters", this._profileIDMap);
                }
            }

            object.modes = this.utils.getDecodedList(elem, 'modes', Namespaces.SML, this._profileIDMap, (mode) => this.decodeModes(mode));
    ...
    public decodeConnection(elem: Element): ReturnObject<Connection> {
        ...
        if (connectionElem != null) {
            ...
            let returnObject: ReturnObject<string> = this.utils.getAttributeOfElement(connectionElem, 'source', Namespaces.SML, 'ref', '');
            if (returnObject) {
    ...
    public decodeNamedSweDataComponent(elem: Element): ReturnObject<NamedSweDataComponent> {
        if (elem != null) {
            ...
            if (elem.firstElementChild != null) {
                let returnObject: ReturnObject<AbstractDataComponent> = this.sweDecoder.decodeDataComponent(elem.firstElementChild);
                if (returnObject) {
    ...
    public decodeKeywordList(elem: Element): ReturnObject<KeywordList> {
        ...
        if (keywordListElem != null) {
            ...
            let returnObject: ReturnObject<string> = this.utils.getAttributeOfElement(keywordListElem, 'codeSpace', Namespaces.SML, 'href', Namespaces.XLINK);

            if (returnObject) {
                keywordList.codeSpace = returnObject.value;
                this._profileIDMap = this.utils.processProfileID(returnObject.docElement, keywordList, "codeSpace", this._profileIDMap);
            }
        ...
        if (eventElem != null) {
            ...
            if (timeElem != null) {
                ...
                if (returnObject) {
                    ...
                    this._profileIDMap = this.utils.processProfileID(returnObject.docElement, event, "time", this._profileIDMap);
                }
            }
            ...
            if (configurationElem != null) {
                ...
                if (returnObject) {
                    ...
                    this._profileIDMap = this.utils.processProfileID(returnObject.docElement, event, "configuration", this._profileIDMap);
                }
            }
    ...
    public decodeSetConstraint(elem: Element): ReturnObject<ConstraintSetting> {
        ...
        if (elem.firstElementChild != null) {
            let returnObject: ReturnObject<AllowedTimes | AllowedTokens | AllowedValues> = this.sweDecoder.decodeConstraint(elem.firstElementChild);
            if (returnObject) {
    ...
    public decodeTerm(elem: Element): ReturnObject<Term> {
        ...
        if (termElem != null) {
            ...
            let returnObject: ReturnObject<string> = this.utils.getAttributeOfElement(termElem, 'codeSpace', Namespaces.SML, 'href', Namespaces.XLINK);
            if (returnObject) {
